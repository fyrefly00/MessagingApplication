...
public class ChatClient2 {
    public static void main(String [] args) throws IOException {
        ...
        // byte initBuf[] = null;
        // String hello = username + " " + localAddress.getHostAddress();
        // initBuf = hello.getBytes();
        // DatagramPacket helloPacket = new DatagramPacket(initBuf, initBuf.length, address, 1234);
        // ds.send(helloPacket);

        // byte recieveBuf[] = new byte[65535];
        // DatagramPacket recievedHello = new DatagramPacket(recieveBuf, recieveBuf.length);
        // ds.receive(recievedHello);
        // String recievedHelloMessage = data(recieveBuf).toString();
